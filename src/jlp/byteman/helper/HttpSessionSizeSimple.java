...
public class HttpSessionSizeSimple extends MyHelper {
	...
	protected HttpSessionSizeSimple(Rule rule) {
		super(rule);
	...
	private HashMap<String, Long> hmCounter = new HashMap<String, Long>();

	// System.out.println("Utilisation pointcut methods");

	public String toTrace(Object sess, String methodName, boolean boolSerialization,String strategy,int count) {
		...
		try {
			...
			System.out
					.println("  methods passage 1 IllegalArgumentException Byteman Helper => HttpSessionSizeSimple methods :"
							+ e2.getMessage());
			...
			System.out
					.println(" methods passage 1 SecurityException  Byteman Helper=> HttpSessionSizeSimple methods :"
							+ e2.getMessage());
			return sep+sep+sep+sep+sep+sep+sep;
		} catch (IllegalAccessException e2) {
			System.out
					.println(" methods passage 1 IllegalAccessException  Byteman Helper => HttpSessionSizeSimple methods :"
							+ e2.getMessage());
			return sep+sep+sep+sep+sep+sep+sep;
		} catch (InvocationTargetException e2) {
			System.out
					.println(" methods passage 1 InvocationTargetException  Byteman Helper=> HttpSessionSizeSimple methods :"
							+ e2.getMessage());
			System.out
			...
			System.out
					.println(" methods passage 1 NoSuchMethodException  Byteman Helper => HttpSessionSizeSimple methods :"
							+ e2.getMessage());
			return sep+sep+sep+sep+sep+sep+sep;
		}
		...
		try {
			...
			System.out
					.println(" methods passage 2 IllegalArgumentException Byteman Helper => HttpSessionSizeSimple methods:"
							+ e2.getMessage());
			return sep+sep+sep+sep+sep+sep+sep;
		} catch (SecurityException e2) {
			System.out
					.println("methods passage 2 SecurityException Byteman Helper => HttpSessionSizeSimple methods :"
							+ e2.getMessage());
			return sep+sep+sep+sep+sep+sep+sep;
		} catch (IllegalAccessException e2) {
			System.out
					.println(" methods passage 2 IllegalAccessException Byteman Helper => HttpSessionSizeSimple methods :"
							+ e2.getMessage());
			return sep+sep+sep+sep+sep+sep+sep;
		} catch (InvocationTargetException e2) {
			System.out
					.println(" methods passage 2 InvocationTargetException Byteman Helper => HttpSessionSizeSimple methods :"
							+ e2.getMessage());
			System.out
			...
			System.out
					.println(" methods passage 2 NoSuchMethodException Byteman Helper => HttpSessionSizeSimple methods :"
							+ e2.getMessage());
			return sep+sep+sep+sep+sep+sep+sep;
		}
		...
		// ecriture
		return (new StringBuilder().append(prefix).append(methodName)
				.append(sep).append(name).append(sep).append(sessionId)
				.append(sep).append(nbObjects).append(sep)
